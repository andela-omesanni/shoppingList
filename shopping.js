...
$(document).ready(function() { 
        ...
        function add(item) {
              var appendItem =  '<div id="wrap"><div style="float: left; width: 80%">';
                  appendItem += '<span><input type="checkbox"> <label>' + item; 
                  appendItem += '</label></span></div><div style="width:40%; position: relative; top: -18px;';
                  appendItem += 'left: 90%; clear: both;"><a href="#" class="delete">';
                  appendItem += '<img src="images/delete.png"/></a></div></div>';
